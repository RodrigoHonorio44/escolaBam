...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const loginLogic = async () => {
      ...
      if (user.email === "rodrigohono21@gmail.com") {
        ...
        if (querySnapshot.empty) {
          await setDoc(rootRef, {
            ...
            status: "ativo",
            statusLicenca: "ativa",
            licencaStatus: "ativa", // Adicionado para consistência com o banco
      ...
      // VERIFICAÇÃO DE BLOQUEIO (Múltiplos campos de segurança)
      const isBloqueado = 
      ...
      if (isBloqueado) {
        await signOut(auth); // Garante que o Firebase deslogue o usuário bloqueado
        ...
        <div className="w-full max-w-[420px] animate-in fade-in slide-in-from-right duration-700">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div className="group space-y-2">
              <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1 transition-colors group-focus-within:text-blue-600">E-mail Corporativo</label>
            ...
            <div className="group space-y-2">
              <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1 transition-colors group-focus-within:text-blue-600">Senha de Segurança</label>
              <div className="relative">
          ...
          <div className="mt-16 pt-8 border-t border-slate-100 flex justify-between items-center">
             <div>
                <p className="text-[10px] text-slate-900 font-black uppercase tracking-tighter italic">Rodhon<span className="text-blue-600">Baenf</span></p>
          ...
          <div className="bg-white w-full max-w-md rounded-[40px] p-12 shadow-2xl relative border border-slate-100 overflow-hidden">
            ...
            <div className="text-center">
              ...
              <div className="space-y-4">
                ...
                <a href="mailto:rodrigohono21@gmail.com" className="flex items-center justify-center gap-3 w-full bg-slate-900 text-white py-5 rounded-[22px] font-black uppercase text-[10px] tracking-[0.2em] hover:bg-slate-800 transition-colors">Enviar E-mail</a>
              </div>
            </div>
          </div>
        </div>
